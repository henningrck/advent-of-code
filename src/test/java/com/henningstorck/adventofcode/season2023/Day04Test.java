...
class Day04Test {
    public static Stream<Arguments> inputs() {
        return Stream.of(
                Arguments.of(InputReader.readRawInput("/inputs/season2023/day04/example.txt"), 13, 30),
                Arguments.of(InputReader.readRawInput("/inputs/season2023/day04/henning.txt"), 28750, 10212704)
        );
    }
