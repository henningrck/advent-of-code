...
class Day01Test {
    public static Stream<Arguments> inputs() {
        return Stream.of(
                Arguments.of(InputReader.readRawInput("/inputs/season2024/day01/example.txt"), 11, 31),
                Arguments.of(InputReader.readRawInput("/inputs/season2024/day01/henning.txt"), 1938424, 22014209)
        );
    }
